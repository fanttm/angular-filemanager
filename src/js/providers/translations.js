(function(angular) {
    ...
    angular.module('FileManagerApp').config(['$translateProvider', function($translateProvider) {
        $translateProvider.translations('zh', {
            ...
            close: '关闭',
            upload_file: '文件上传',
            files_will_uploaded_to: '文件将被上传到',
            uploading: '上传中',
            permissions: '访问权限',
            ...
            select_new_folder_for: '请选择目标文件夹：',
            ...
            compress: 'Compress',
            newwindow: '打开脑图',
            error_invalid_filename: '文件或文件夹名称无效，或已存在，请输入新名称',
            error_modifying: 'An error occurred modifying the file',
            error_deleting: '删除文件或文件夹失败',
